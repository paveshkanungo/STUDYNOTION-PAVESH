...
const Home = () => {
  return (
    <div>
        ...
        <div className='relative mx-auto flex flex-col w-11/12 items-center text-white justify-between gap-8 max-w-maxContent'>
            ...
            <div>
                <CodeBlocks 
                    ...
                    subheading={
                        "Our courses are designed and taught by industry experts who have years of experience in coding field and are passionate about sharing their knowledge with you."
                    }
                    ctabtn1={
                        {
        ...
        {/* {Section*3} */}
        <div className='w-11/12 mx-auto max-w-maxContent flex-col items-center gap-8 justify-between first-letter bg-richblack-900 text-white  '>
