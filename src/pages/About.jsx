...
const About = () => {
  return (
    <div>
      ...
      {/* Section 3 */}
      <section>
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between text-richblack-500 gap-10">
          {/* Founding Story wala div */}
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            {/* Founding Story ka left box */}
      ...
      {/* Section 5 */}
      <section className="mx-auto mt-24 flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-white">
        <LearningGrid />
        <ContactFormSection />
      </section>
